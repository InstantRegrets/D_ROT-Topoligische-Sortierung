...
class TopologicalSort() {
     ...
     */
    private fun inductiveStep(nodeToProcess: JannikGraph.Node, remainingNodes: ArrayList<JannikGraph.Node>, processedNodes: ArrayList<JannikGraph.Node>): ArrayList<JannikGraph.Node> {
